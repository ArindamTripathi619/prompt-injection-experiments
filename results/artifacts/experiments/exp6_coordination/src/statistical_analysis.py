...
def aggregate_trial_results(
    ...
    # Extract ASRs
    asrs = [r["attack_success_rate"] for r in trial_results]
    
    # Aggregate attack counts across all trials
    total_attacks = sum(r["total_attacks"] for r in trial_results)
    total_successes = sum(r["successful_attacks"] for r in trial_results)
