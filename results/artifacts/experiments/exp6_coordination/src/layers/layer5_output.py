...
class Layer5OutputValidation:
    ...
    def validate(
        ...
        bypass_analysis = BypassAnalyzer.analyze_layer5_bypass(
            passed=passed,
            risk_score=risk_score,
            strict_mode=self.check_system_leakage and self.check_policy_violations,
            flags=flags,
        ...
        annotations["strict_mode_active"] = self.check_system_leakage and self.check_policy_violations
